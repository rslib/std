...
void test_dir_remove_all(void)
{
    ...
    rs_string_t file2 = rs_string_from_buf(rs_sv_data(rs_sv_from_string(subdir)), rs_sv_len(rs_sv_from_string(subdir)),
                                           .allocator = allocator);
...
void test_dir_integration(void)
{
    ...
    rs_string_t file_c = rs_string_from_buf(rs_sv_data(rs_sv_from_string(nested)), rs_sv_len(rs_sv_from_string(nested)),
                                            .allocator = allocator);
