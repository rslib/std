...
function(rs_add_source_library)
  ...
  if(LIB_BUILD_STATIC)
    ...
    # On Windows, add _static suffix to avoid conflict with shared library import lib
    if(WIN32)
      set(STATIC_OUTPUT_NAME ${LIB_OUTPUT_NAME}_static)
    else()
      set(STATIC_OUTPUT_NAME ${LIB_OUTPUT_NAME})
    endif()
